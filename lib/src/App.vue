		...
		<main class="pettycash-content">
			...
			<header class="pettycash-header">
				...
				<span class="phase-badge">
					{{ t('pettycash','v2.0.0 — person & destination routing') }}
				</span>
			...
			>
				...
				<article class="hero-card">
					...
					<h2>
						{{ t('pettycash','Person-and-destination-centric approvals') }}
					</h2>
					...
					<p>
						{{ t(
							'pettycash',
							'Manager 1 is resolved from the purchaser; Manager 2 from the destination. A manager who is also a purchaser (e.g. on their own business trips) uses the Cost Lists and Approvals views side by side.'
						) }}
					</p>
				...
				<article class="status-card">
					...
					<ul>
						...
						<li>
							✓ {{ t('pettycash','Person-based Manager 1 assignment') }}
						</li>

						<li>
							✓ {{ t('pettycash','Destination-based Manager 2 assignment') }}
						</li>

						<li>
							✓ {{ t('pettycash','Regular and Business Trip Cost Lists') }}
						</li>

						<li>
							✓ {{ t('pettycash','Non-blocking Manager 1 decisions') }}
						</li>

						<li>
							→ {{ t('pettycash','Accountant dashboard and reporting') }}
						</li>

						<li>
							→ {{ t('pettycash','Petty cash balance/deposit visibility (planned)') }}
						</li>
			...
			>
				...
				<h2>
					{{ t(
						'pettycash',
						'This module is scheduled for the next implementation phase.'
					) }}
				</h2>
				...
				<p>
					{{ t(
						'pettycash',
						'Accountant reporting is a planned module (see the v2.0.0 roadmap).'
					) }}
				</p>
