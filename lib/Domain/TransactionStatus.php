...
final class TransactionStatus {
    ...
    public const APPROVED_M2 = 'APPROVED_M2';
    ...
    public const RETURNED_ACCOUNTANT = 'RETURNED_ACCOUNTANT';
    public const REJECTED_ACCOUNTANT = 'REJECTED_ACCOUNTANT';
    public const APPROVED_ACCOUNTANT = 'APPROVED_ACCOUNTANT';
    ...
    public const ALL = [
        ...
        self::RETURNED_ACCOUNTANT,
        self::REJECTED_ACCOUNTANT,
        self::APPROVED_ACCOUNTANT,
