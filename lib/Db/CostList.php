...
final class CostList extends Entity {
    ...
    protected int $jalaliYear = 0;
    protected int $jalaliMonth = 0;

    protected string $status = 'OPEN';

    protected int $submittedTotal = 0;
    protected int $manager1Total = 0;
    protected int $finalTotal = 0;

    protected int $createdAt = 0;

    protected ?int $submittedAt = null;
    protected ?int $manager1CompletedAt = null;
    protected ?int $manager2CompletedAt = null;
